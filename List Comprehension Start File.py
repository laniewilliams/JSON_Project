...
letter = ["this","is","a","list","of","words"]
first=[i[0] for i in letter] #gets the first letter in each word
print(first)
...
new_range = [i*i for i in range(5) if i % 2 ==0] #checks if it has zero remainder when divided by 2
print(new_range)
...
new = [i for i in string if i.isdigit()]
print(new)
...
fl = open("test.txt","r")
result = [i.strip('\n') for i in fl if "line3" in i] #strip would go on the expression
print(result)
